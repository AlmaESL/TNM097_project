...
while True:
    ...
    if len(computer_frame_buffer) == MAX_FRAMES and len(phone_frame_buffer) == MAX_FRAMES:
        ...
        log_computer_results(computer_avg_std, avg_computer_color_diff, comp_max_diff, comp_max_pos, computer_avg_niqe, computer_avg_brisque, computer_avg_paq2piq)
        log_phone_results(phone_avg_std, avg_phone_color_diff, phone_max_diff, phone_max_pos, phone_avg_niqe, phone_avg_brisque, phone_avg_paq2piq)
